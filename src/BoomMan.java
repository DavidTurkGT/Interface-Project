 ...
 */
public class BoomMan extends Soldier implements Grenadier {

    private String[] ranks = {"tiny","big","boomboom","moab","nuclear"};

    public BoomMan(String name, String rank, int serviceNumber) {
        this.name = name;
